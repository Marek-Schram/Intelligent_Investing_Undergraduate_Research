...
def _empty_13f() -> pd.DataFrame:
    return pd.DataFrame(columns=["filed_at", "ticker", "manager_name", "is_top_10", "action"])
            ...
            [
                {
                    "filed_at": "2024-03-15",
                    "transaction_code": "F",
                    "is_officer_director": True,
                    "amount_usd": 500_000,
                    "is_10b5_1": False,
                    "shares_transacted": 0,
                    "insider_shares_held": 10000,
                },
                {
                    "filed_at": "2024-04-01",
                    "transaction_code": "F",
        ...
        df = pd.DataFrame(
            [
                ...
                },
                {
                    ...
                    "amount_usd": 120_000,
                    "is_10b5_1": False,
                    "shares_transacted": 800,
                    "insider_shares_held": 30000,
                },
            ]
        )
            ...
            [
                {
                    ...
                    "amount_usd": 50_000,
                    "is_10b5_1": False,
                    "shares_transacted": 500,
                    "insider_shares_held": 20000,
                },
            ]
        )
        ...
        df = pd.DataFrame(
            [
                ...
                },
                {
                    ...
                    "amount_usd": 200_000,
                    "is_10b5_1": True,
                    "shares_transacted": 1500,
                    "insider_shares_held": 40000,
                },
            ]
        )
        assert insider_overlay(df, as_of) == 0
            ...
            [
                {
                    ...
                    "has_committee_jurisdiction": True,
                },
                {
                    "filed_at": "2024-05-15",
                    "ticker": "AAPL",
                ...
                },
                {
                    ...
                    "ticker": "AAPL",
                    "transaction_type": "purchase",
                    "has_committee_jurisdiction": False,
                },
            ]
        )
